...
import LearnerAnalysisDashboard from '@/components/teacher/LearnerAnalysisDashboard'
...
export default function LearnerAnalysisPage() {
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">🎯 학습 활동 추천</h1>
              <p className="text-gray-600">경험 기반 학습 활동과 실습 방법 제안</p>
            </div>
