...
import InstructorAnalysisDashboard from '@/components/teacher/InstructorAnalysisDashboard'
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">🔒 실무 중심 분석</h1>
              <p className="text-gray-600">비즈니스 임팩트와 축적 역량 중심의 교육 효과성 분석</p>
            </div>
