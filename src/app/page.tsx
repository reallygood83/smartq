    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-700 dark:text-white mb-2">
            ...
            <Card>
              <div className="text-center">
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="sessionCode" className="block text-sm font-medium text-gray-700 dark:text-white mb-2">
                      세션 코드 (6자리)
                    </label>
                    <input
                      type="text"
                      id="sessionCode"
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md text-center text-lg font-mono uppercase tracking-wider focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-200"
