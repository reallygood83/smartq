    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <label className="flex items-center">
          ...
          />
          <span className="ml-2 text-sm text-gray-700 dark:text-gray-100">익명으로 질문하기</span>
        </label>
        <label className="flex items-center">
          <input
            type="radio"
            ...
            className="text-blue-600 focus:ring-blue-500"
          />
          <span className="ml-2 text-sm text-gray-700 dark:text-gray-100">이름을 남기고 질문하기</span>
        </label>
      </div>
      ...
      {!isAnonymous && (
        <div>
          <label htmlFor="studentName" className="block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">
            이름
          </label>
          <input
            type="text"
      ...
      {/* 질문 입력 */}
      <div>
        <label htmlFor="questionText" className="block text-sm font-medium text-gray-700 dark:text-gray-100 mb-1">
          질문 내용
        </label>
        <textarea
          id="questionText"
